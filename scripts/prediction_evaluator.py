...
from worldcup_core import edition_data_root, iso_now, load_json, prediction_report_path, save_match_ledger, wiki_edition_root, write_json, write_text  # noqa: E402
...
def evaluate_predictions(*, root: Path, edition: str, date: str, now: str | None = None) -> dict:
    ...
    ledger = load_json(edition_data_root(root, edition) / "match-ledger.json", {"matches": []})
