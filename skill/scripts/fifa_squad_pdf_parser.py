...
from worldcup_core import raw_edition_root, edition_data_root, iso_now, slugify, wiki_edition_root, worldcup_db_path, write_json, write_text  # noqa: E402
...
def write_roster_outputs(*, root: Path, edition: str, roster: dict, output: Path | None = None, update_edition_teams: bool = False) -> dict:
    ...
    output = output or (raw_edition_root(root, edition) / "rosters" / "fifa-squad-lists.json")
